...
TODO: Is "copy editor" the right term?
...
As you might notice from the graph, my readership went from "too insignificant to appear in a graph" for almost the entire first year of the blog to to over 9,000 readers per week starting this May. In weeks where I published a new post, this number could reach as high as 50,000.
...
One surprising insight was how frequently I assumed that my readers shared my frame of reference when they probably didn't. Extremely popular in Manhattan. Not so popular in Wisconsin, where Samantha lives.
...
After I thought about it for a few days, I thought, "Why *can't* it be a story?"

## Telling it like a story

I realized that this could be one of those "stories" that Samantha had been telling me about.
...
{% capture fig_caption %}
Positive comments on the post's writing style &emdash; creating this collage does not count as narcissism because it's for a blog post.
{% endcapture %}
