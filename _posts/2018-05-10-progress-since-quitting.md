...
{% include image.html file="nerd-summit.jpg" alt="NERD Summit logo" max_width="230px" class="align-left" link_url="https://nerdsummit.org/" %}

In March, I gave my first ever conference presentation. I adapted my favorite post from the blog, ["How to Do Code Reviews Like a Human,"](/human-code-reviews-1/) and presented it at [NERD Summit](https://nerdsummit.org/), a newcomer-friendly conference in Western Massachusetts.
...
The problem was that I took on too many projects. While I was an employee, eight hours a day in the office felt like an eternity. I predicted that cutting those out would give me eternal *free* time.
...
I turned my attention back to [KetoHub](https://mtlynch.io/outsourcing-mvp/), a website I created last year to aggregate recipes for the keto diet.

KetoHub allows users to search by ingredient, so if you have ground beef you'd like to cook, you can search ["ground beef"](https://ketohub.io/?q=%22ground%20beef%22) and find 50 different keto-friendly recipes that use it:
...
I wanted a more flexible way for KetoHub to process ingredients.
...
{% assign fig_caption = "Visualization of *The New York Times*' ingredient parser results" | markdownify | remove: "<p>" | remove: "</p>" %}
...
For the next few weeks, I'm going to focus on reaching out to different app developers about whether the Ingredient Parser API can be useful for them. By June, I hope to refine the API based on feedback and publish it to marketplaces like [Mashape](https://market.mashape.com/) and [RapidAPI](https://rapidapi.com/).
