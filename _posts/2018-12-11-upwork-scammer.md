...
When I checked Lizzie's timesheet, I realized that Lizzie had logged her hours using Work Diary, Upwork's official spyware tool. It records the freelancer's screen, records their keystrokes, and sends all the information to both Upwork and the client.
...
Unless there's a new trend in the keto diet that requires reading tarot cards, this didn't seem like it was related to my project either.

# What's going on here?

The plot thickened when one screenshot showed Lizzie using Upwork's messaging interface to talk to her other clients:
...
It  confused me at first because it showed two people talking but neither of them was Lizzie. Then, I realized she was logged in as a separate Upwork user with the name Abi Hensley.
...
Two days later, Upwork customer support responded:
...
It has been two weeks since I reported the fraud. The profiles went private a few days after I reported the issue, but Upwork still shows both profiles as active and accepting job offers:
...
In my post-job feedback, I called out the profile as fraudulent. I kept it objective and factual, but I said that Work Diary revealed billing for unrelated work and multiple Upwork profiles. Curiously, Upwork displays my review as "No feedback given":

{% include image.html file="lizzie-feedback.jpg" alt="Upwork shows I left no feedback for Lizzie" max_width="697px" img_link="true" fig_caption="Upwork does not display my comments about Lizzie's fraudulent account in her Upwork profile." %}

I contacted one of Lizzie's other clients. He had hired "Abi" to write sales copy on his company's website. He told me that he appreciated me warning him about the fraud &mdash; Upwork never did.

# Upwork's cross-contamination problem

If you raised an eyebrow about me contacting another of Lizzie's clients, that's because I shouldn't be able to do it. A freelancer's client list is private on Upwork, but Lizzie bled enough information into her Work Diary screenshots that I could find one of her other clients.

This leads to another interesting problem with Upwork's Work Diary feature: cross-contamination.

What if a freelancer applied to work for you and ended their cover letter included this note:

>By the way, I routinely run software that sends captures of my entire screen to undisclosed third-parties. Hope that doesn't bother you!
