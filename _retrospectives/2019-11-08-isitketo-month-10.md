...
{% include image.html file="reddit-post.jpg" alt="reddit post asking for meal plan advice" max_width="636px" img_link="true" class="img-border" fig_caption="reddit user asking where to find keto meal plans" %}
