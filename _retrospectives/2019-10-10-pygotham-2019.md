...
**Note**: If you're on Ubuntu/Debian, take out the `--compression=auto` flag, since your version of wget [won't support it](https://unix.stackexchange.com/a/464375/152974).
{: .notice--info}
