...
{% include image.html file="whatgotdone.jpg" alt="What Got Done screenshot"  max_width="800px" img_link="true" fig_caption=fig_caption %}
...
<figure class="half">
  {% include image.html file="email-comments.png" alt="Wireframe of feedback view" max_width="81%" img_link="true" media_rendition="half" %}
  {% include image.html file="email-diff.png" alt="Wireframe of diff view" img_link="true" media_rendition="half" %}
