...
* I'm struggling to get unstuck in two processes that have been stuck for months: hardware development and website development.
...
This release went well and came out on schedule. It wasn't especially exciting feature-wise, but we polished existing features and paid down technical debt.
...
Revenue slipped this month, as I haven't been investing as much into marketing. It's a relief that I can maintain this revenue without a major marketing push in the last two months, but I need to step it up in July.

### Create a prototype of the TinyPilot Voyager 2, with built-in Power over Ethernet

* **Result**: Scoped the project down to just a more compact Voyager without Power over Ethernet
* **Grade**: D
...
We ultimately decided to drop PoE as a Voyager 2 feature and just reduce the number of external wires and connectors. We likely won't have the first prototype until mid-July.
...
My profits are misleading because of changes in the Raspberry Pi supply chain. The Pi is the most expensive part in TinyPilot, and my Pi costs have drastically increased. There's an ongoing chip shortage, so I've had to double the amount I keep in inventory to weather the storm. I've also had to upgrade from the 2 GB model to the doubly expensive 4 GB model, as the 2 GB are out of stock everywhere. There's probably a better way for me to represent finances taking into account the value of my inventory, but I haven't gotten there yet.

## Finding ways to free up time

I recently read the book [*The Goal*](/book-reports/the-goal/), which is all about the "bottlenecks" of a business. The bottleneck is the limiting factor of a system. As an example, suppose you have a product that needs to go through two machines: machine A and machine B. If machine A can process 100 units per week, and machine B can process 500 units per week, machine A is the bottleneck. If someone gave you an additional machine B for free, it would have no effect on your business because you can still only produce 100 units per week until you get more of machine A.
...
Today, the bottleneck on fulfillment is just market demand. We usually ship one to five orders per day, but if I increased our sales, we could likely ship out five times the orders without hitting a bottleneck in the fulfillment process.

Still, there are several areas of the business where I'm the bottleneck: marketing, customer support, management, software development, hardware development. As I realized last month, [management has ballooned up](/retrospectives/2021/06/#im-just-a-manager) to occupy almost all of my time. I'm staying afload in other areas, but I don't feel like I'm improving them. And I neglect marketing because it's [important but not urgent](/book-reports/7-habits-of-highly-effective-people/#time-management-matrix).

I'm continuing to look for ways of delegating more of my work to the people that work with me. Here's what I did last month:
...
The first factor is design work. The early work we did on TinyPilot was small as far as electrical engineering projects go. As I progressed forward, I invested more into up-front design and customer research to verify that we were doing the right thing. So even though it *feels* like we have nothing to show for that time, we wrote design documents that advanced the project.
...
Then, the [global chip shortage](https://en.wikipedia.org/wiki/2020%E2%80%9321_global_chip_shortage) hit. The widely available $4 PoE components were sold out everywhere. Over a few weeks, I increased the price cap to $40/unit, then $60/unit, and the electrical engineers still couldn't find anything, despire checking vendor supplies daily for months.
...
Vendor C's proposal was extremely vague and buzzwordy to the point where I couldn't understand what they were offering to do. I asked them to revise it, and the new proposal isn't much better. They misspelled "TinyPilot," made several grammatical errors in a single page, and gave no indication that they've even read my spec. They want $5k to do a 35-hour preliminary investigation and prepare a presentation outlining my options.

If my original EE firm had access to components they need, they could probably design the PCB and manufacture an initial batch with 10-15 hours of work. 35 hours just to come up with a plan seems excessive.
...
When I received an email a couple months ago from a German guy offering to distribute TinyPilot in the EU, I was skeptical. But unlike his predecessors, when I asked about his plans, he had practical ideas and told me about his experience in this space.
...
We ended up on opposite sides of the negotitating table. His initial proposal gave me a 10% bigger share of the profits than my own initial proposal. So, we met in the middle and both felt like we got a good deal.

I'm excited about this partnership because it makes TinyPilot more appealing to users in the EU, who might otherwise be dissuaded by the high tariffs, slow shipping speed, and incompatible power adapter. It also means that marketing effort from either of us benefits us both.
...
* When a task can't be outsourced, look for subtasks that can be.
  * I've been the only person handling marketing or customer support because they require knowledge and skills that cross multiple domains of the business, but I can outsource some of the legwork.

### Goals for next month

* Get my EU partner ready to begin sales by end of August.
* Define processes that allow TinyPilot's local staff to share and alternate all tasks.
* Find a designer for the TinyPilot sales site.
* Find an electrical engineering firm who can create a PoE adaptor for TinyPilot Voyager.
