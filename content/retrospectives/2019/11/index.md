...
{{<img src="smoke-test.jpg" alt="Screenshot of Is It Keto smoke test" caption="Meal plan smoke test" max-width="600px">}}
...
{{<img src="tex-mex-v1.jpg" alt="Screenshot of first Tex-Mex sales page" caption="Putting my first meal plan up for sale" max-width="416px">}}

Only one customer had signed up for my mailing list, but she purchased a plan within two hours of launch:

{{<img src="first-payment.jpg" alt="Screenshot of Stripe payment receipt" caption="My first Is It Keto meal plan sale" max-width="601px">}}
...
{{<img src="self-ads.jpg" alt="Screenshot of self-ad on Gatorade Zero page" caption="I added self-ads for my meal plans to [other Is It Keto pages](https://isitketo.org/gatorade-zero)" max-width="800px">}}
...
{{<img src="self-ads-chart.jpg" alt="Chart showing indeterminate effect of self-ads" caption="Self-ads may have brought more visitors to the page, but it's too little data to say for sure" max-width="800px">}}
...
{{<img src="tex-mex-v2.jpg" alt="Screenshot of first Tex-Mex sales page" caption="Slashing the price on my meal plan" max-width="416px">}}
...
{{<img src="reddit-post.jpg" alt="reddit post asking for meal plan advice" caption="reddit user asking where to find keto meal plans" max-width="636px">}}

{{<img src="reddit-invitation.jpg" alt="reddit post asking for meal plan advice" caption="My outreach message to a reddit user seeking meal plans" max-width="702px">}}
...
{{<img src="smoke-test2.jpg" alt="Screenshot of Is It Keto smoke test" caption="Testing the original smoke test to see if 4% of users will still click Buy Now" max-width="600px">}}
...
{{<img src="tex-mex-v3.jpg" alt="Screenshot of latest Tex-Mex sales page" caption="Putting each meal plan into its own individual, more detailed page" max-width="800px">}}
