...
The biggest problem is that it takes an entire day to see if you were right, and waiting 24 hours to get any feedback really sucks the fun out of it. So, I tried reducing it to just 30 minutes, but that's still pretty boring.
...
My wife and I had our first child last year, so we wanted a private way to share baby photos with our family. Some of my friends had used apps like this, but they were all ad-supported. I hate the idea of companies slapping ads on photos of my child, so I looked for other options.

When I came across TinyBeans, I thought I'd found a winnder. They had a paid tier where you could disable ads, and their main value proposition was user privacy: perfect!

And then I started using TinyBeans, and there were ads everywhere. Buy our photo books! Give us more personal information! I just opened the app and had to dismiss three separate ads to see photos of my own child.

{{<gallery caption="TinyBeans shows me three huge ads when I open the app, even though I've dismissed these exact ads dozens of times before.">}}
...
It also turns out that all of my family members receive not just ads for TinyBeans but for third-party services. The photos of my son that landed in their inboxes were surrounded by ads for vaccum cleaners and paper towels.

The final straw was over Black Friday. TinyBeans sent me an email telling me that they wouldn't clutter my inbox with Black Friday deals because all the deals would be in the app.
...
Who cares? I already pay you not to show me ads! Stop bothering me.

More outrageously, that was a lie. TinyBeans proceeded to send me four more emails telling me to check my app for exciting deals:
...
That pushed me over the edge, and now I'm on a spite-mission to replace TinyBeans and stop giving them my money.

{{<img src="reasons.webp" caption="&ldquo;And what are your reasons for wanting to create a TinyBeans alternative?&rdquo;">}}
...
How hard could that be? 20 hours of dev work? The TinyBeans Android app sucks anyway, so I'll be glad to move away from it.

## Switching to Awesome Window Manager

I've never been interested in Window managers. My shameful secret is that I'm sloppy about managing my windows, and I compensate by overusing my mouse, which makes me slow to navigate my desktop.
...
- I just discovered ["Rich Friend, Poor Friend"](https://www.jenn.site/rich-friend-poor-friend/) from 2022 and found it an
