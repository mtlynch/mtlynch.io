...
I was [talking to LGUG2Z](https://m.mtlynch.io/@michael/115538492543985760) on Mastodon about how annoying it is to embed tweets from social media on my blog. If the user deletes their tweet, I end up with dead content in my post. And even when it works, I end up loading Twitter trackers on my blog. I've been working around it by just screenshotting tweets, but that's an ugly solution.
