...
{{<img src="ps-edit-file.png" alt="Screenshot of metadata edit screen in PicoShare" caption="In May, I added support in PicoShare for editing file metadata.">}}
...
{{<img src="ps-confirm-delete.png" alt="Screenshot of delete confirmation dialog in PicoShare" caption="I added a confirmation dialog to reduce accidental file deletes.">}}
...
{{<img src="wanderjest-before.png" alt="Screnshot of WanderJest live site" max-width="450px">}}
{{<img src="wanderjest-after.png" alt="Screenshot of new Go-based WanderJest site" max-width="467px">}}
{{</gallery>}}
...
- Published [a new TinyPilot release](https://tinypilotkvm.com/blogs/news/whats-new-in-2022-05).
