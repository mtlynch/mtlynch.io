...
Visits were down a little

## Where do _Refactoring English_ readers come from?

I mentioned [in January](/retrospectives/2026/01/#adding-regional-pricing-for-my-book) that I added regional pricing for my book. I wasn't tracking data carefully, but just based on new order notifications, it seemed like most of my orders were coming from countries outside the US, so I took a closer look at the data since my regional pricing announcement.
...
Since December, I've been spending more and more time doing AI-assisted coding. It's become a bigger and bigger part of how I spend my workday and non-work time.

I used to have a bad habit of checking email and social media excessively. During the past month, I've noticed on multiple days that it's 4pm, and I haven't checked email or social media at all. Except it's because I've fallen into an AI vortex and forgot everything else.
...
In the 90s, Bill Gates published a book called [_Business @ the Speed of Thought_](https://en.wikipedia.org/wiki/Business_@_the_Speed_of_Thought). I've never read it, but I keep thinking back to that book title as I use AI for coding. AI still isn't quite at the speed of thought, but it's closer than anything I ever imagined. I can have an idea for a feature and give the AI agent a brief explanation, and within a few minutes, the feature has materialized.

### AI coding has no natural limits

Even before AI, I'd often intend to spend an hour coding and instead spent three. But there were natural limits to how long I could code. My brain feels fried after a few hours of dev work, and the work becomes unpleasant, unproductive, or both.
...
Whether intentional or not, my experience with AI agents varies wildly. Sometimes, I point it at a 2,000 line log file and it can tell me what I wanted to know without me even having to ask. Sometimes, I give it a clear instruction, and it thinks for five minutes and then comes back to ask me a dumb question instead of just carrying out the task.

But because I don't know if the wait will be 5 seconds or 20 minutes,o I sit there staring at the agent for a minute, then compulsively check it every few minutes, then start some other AI task while I'm waiting. And then I'm cycling between multiple agents and don't even remember what they're all doing.
...
- Don't start the day with an AI project
  - If I start with AI and then try to write, then I'm switching from an exciting, easy task to a hard, unsexy task.
  - If I instead start the day with [an hour of writing](/retrospectives/2025/06/#one-hour-of-good-writing-per-day-works), I've done my hard task for the day and don't have to shift
  - This is the most challenging because I often set up long AI tasks overnight, and I'm always curious in the morning to see how they did.
