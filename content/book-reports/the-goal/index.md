...
The book teaches Goldratt's ideas through in novel format. It makes the book a light, engaging read, but it also feels like a lot of fluff to teach a few simple concepts. I admittedly felt a little silly that the author was doing the equivalent of hiding medicine in my doggie treats because I can't pay attention to a real nonfiction book. That said, the last chapter is pure lessons and no story, and I found it difficult to pay attention and get through it, so maybe I the novel format is what I need to stay engaged.

The protagonist of the story is a struggling factory manager who's mostly helpless without the guidance of his friend, a mysterious and near-omniscient Israeli physicist-turned-business-consultant. By sheer coincidence, the book's author happens to be an Israeli physicist-turned-business-consultant.
...
* It's a light read, as novel format makes it easy to stay engaged.
...
* The novel format is a double edged sword. Although it does make the book an easier read, it also felt like it added a lot of fluff.
* The protagonist's marriage is a huge bummer.
  ...
  * I was expecting the protagonist to realize that he and his wife should have a discussion about dividing responsibilities rather than him constantly breaking commitments to his family for his job. Instead, after his wife leaves, his mother moves in and just takes over all the childcare and household chores.
...
* When Alex first runs into Jonah, Alex brags to him that new robots in his factory lowered cost while improving efficiency by 30%.
...
* When Alex tries to explain the metrics his company used to declare the robots effective, Jonah claims that all of Alex's metrics are meaningless.
...
* Every factory strives to be perfectly "balanced."
  * Balanced means that the capacity for every resource perfectly matches market demand.
...
After Alex's plant implements all these changes, the plant ships a record number of orders for the month. But then the following month, orders start running late again and huge queues form in front of bottleneck resources.
...
### Generalized process of bottleneck-oriented improvement

1. Identify the system's constraints (bottlenecks).
1. Decide how to exploit the bottlenecks (i.e. maxmimize utilization of the bottleneck resources).
1. Subordinate everything else to the above decision.
1. Elevate the system's bottlenecks (make changes that reduce bottleneck load or increase capacity).
1. If, in a previous step, you eliminate a bottleneck, go back to step 1.

### Profit by selling products for a loss

* Alex's plant becomes so efficient that they have 20% spare capacity and can't find orders to fill it.
* Alex offers to sell products for below cost to increase profit.
