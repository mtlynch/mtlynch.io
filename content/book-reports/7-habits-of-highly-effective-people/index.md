...
* First 150 years of American literature on success focuses on principles, values, and how to deeply examine oneself to live with integrity.
...
* "Character ethic": people can only experience true success and sustainable happiness if they learn principles of effective living and conssciously align their lives with those principles.
* "Personality ethic": people can achieve success through short-term, superficial techniques like smiling more or remindig themselves of motivational catchphrases (e.g., "your attitude determines your altitude").
...
* Personality ethic strategies are sometimes beneficial, but they're secondary.
  * Character ethic is foundational to success.
...
* The habits in this book move a person progressively through a maturity continuum:
  1. Dependence: Need others to sustain yourself and achieve your goals.
...
* Production vs. production capability examples
  * Physical (lawnmower)
    * If you keep using a lawnmore and ignore maintenance tasks, the engine and blades will degrade to a point past repair.
  * Financial
    * Withdrawing money from an investment reduces the returns it generates.
    * If we fail to advance our career, we get stuck in dead-end jobs.
  * Personal
...
* People achieve professional success by identifying probles and taking initiative to solve them.
...
* The language we use reflects hte degree to which we think about things in proactive terms.
* We often say "I have to do X" when we're actually *choosing* to do X.

TODO: Table from p.78

\[***Ed***: This closely mirrors the idea of ["choicelessness language" in *Nonviolent Communication*](/book-reports/nonviolent-communication/#choicelessness-language)\]
...
* Reactive people focus their energy on issues outside their circle of influence.
  * This leads them to focus on faults of others or in their environment and fosters a victimhood mentality.
...
* We can address (2) by expanding our communication abilities to solve more of these.
...
* You must decide what is your "center."
...
* Your center should be your principles because these can't change out from under you the way a job or money can.
  * Example: You have tickets to take your spouse to a concert, but just before you leave, your boss asks you to work late to prepare for an important meeting.
    ...
    * If you're *principle-centered*, you evaluate your values and which decision serves those values.
...
Even if you have crystal clear principles, the concert example is still a difficult decision because it requires you to predict outcomes with limited information. Will your spouse's disappointment create a rift that ultimately leads to a divorce? Will your boss pass you over for a promotion?
{{</notice>}}
...
* The most extreme approaches to time management require you to [schedule every moment of your day](/book-reports/deep-work/).
...
* The proper way to approach time management is to focus on *relationships* and *results* rather than *things* and *time*.
...
<div id="quadrant-table">
  ...
  <div class="row">
    ...
    <div class="col quadrant quadrant-2">
      <ul>
        <li>Prevention, production capability acitivities</li>
