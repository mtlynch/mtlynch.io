...
{{<img src="parse-example.png" alt="Visualization of ingredient parse result" caption="Breaking an ingredient into its component parts" max-width="600px">}}
...
{{<img src="regex.png" alt="Screenshot of regex implementation" caption="Excerpt from my regular expression code" max-width="450px">}}
...
{{<img src="zestful-logo.png" alt="Zestful logo" caption="[Zestful](https://zestfuldata.com/), a recipe ingredient parsing service" href="https://zestfuldata.com/">}}
...
{{<img src="acceptance-criteria.png" alt="Acceptance criteria document" caption="Ingredient parser acceptance criteria" max-width="300px">}}
...
{{<img src="rapidapi-listing.png" alt="Screenshot of RapidAPI listing" caption="[Zestful listing](https://rapidapi.com/zestfuldata/api/recipe-and-ingredient-analysis) on the RapidAPI marketplace" max-width="800px">}}
...
_Edited by [Samantha Mason](https://www.samanthamasonfreelancer.com). Illustrations by Loraine Yow._
