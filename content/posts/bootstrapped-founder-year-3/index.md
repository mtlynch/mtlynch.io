...
aliases: [/bootstrapped-founder-year-3/]
...
{{<img src="wanderjest-feb-2020.jpg" alt="Screenshot WanderJest website" max-width="600px" caption="[WanderJest](https://wanderjest.com) helps comedy fans find live comedy shows nearby.">}}
...
{{<img src="rebalancer-screenshot.png" alt="Screenshot of Is It Keto website" max-width="550px" caption="[Portfolio Rebalancer](https://rebalancer.mtlynch.io/) helps passive investors manage their investments.">}}
...
Instead, I gained breadth and depth in JavaScript. I already knew [Vue](https://vuejs.org/), but this year, I learned [Gridsome](https://gridsome.org/), a Vue-based static site generator. I used it to build [my TinyPilot sales site](https://tinypilotkvm.com/) and to [rewrite Is It Keto](https://weeks.mtlynch.io/2020-04-17).
...
_Cover image by Loraine Yow. Thanks to [Monica Lent](https://monicalent.com/) and the [Blogging for Devs community](https://bloggingfordevs.com/) for providing early feedback for this post._
