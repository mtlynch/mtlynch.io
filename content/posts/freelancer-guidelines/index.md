...
<table>
  <tr>
   <td><strong>Bad Meeting Discussions</strong>
   </td>
   <td><strong>Good Meeting Discussions</strong>
   </td>
  </tr>
  <tr>
   <td>Can we schedule a meeting to discuss the deadline for this project?
<ul>

<li>BAD: We can figure that out over email.
</li>
</ul>
   </td>
   <td>I've read section X of the spec, but I'm still confused. Can we meet to discuss it?
<ul>

<li>GOOD: This will require a back and forth that would take too many emails.
</li>
</ul>
   </td>
  </tr>
...
I’m not discouraging you from emailing me with questions - I just expect you to answer questions on your own where possible. If you're unable to answer the question on your own, let me know how you've tried to solve this yourself.


<table>
  <tr>
   <td><strong>Bad Questions</strong>
   </td>
   <td><strong>Good Questions</strong>
   </td>
  </tr>
  <tr>
   <td>
...
<li>How do I install Flask on my computer?

<li>Who's Elon Musk?

<li>How do I link to specific sections of a Google Doc?
</li>
</ul>
   </td>
   <td>
...
<li>I'm having trouble understanding section 3 of the spec. Does "bat" refer to sports equipment or the animal?

<li>When I try to install your software, I get the error message <code>FooBarBaz</code>. I've re-read the installation guide and searched the open issues, but I can't figure out what's going wrong. Do you know what the problem is?
</li>
</ul>
   </td>
  </tr>
...
As much as possible, I try to [enforce style consistency with automated tools](https://mtlynch.io/human-code-reviews-1/#let-computers-do-the-boring-parts).
...
<table>
  <tr>
   <td><strong>Examples of non-billable work</strong>
   </td>
   <td><strong>Examples of billable work</strong>
   </td>
  </tr>
  <tr>
   <td>
...
<li>Reading a book cover-to-cover because it’s related to your work
<ul>

<li>Reading a chapter is fine.
</li>
</ul>

<li>Fixing your work computer because your hard drive died

<li>Shopping for a new desk chair
</li>
</ul>
   </td>
   <td>
...
<li>Communicating with me (including emails, video calls, and in-person meetings)

<li>Reading documents I ask you to read (including this one)

<li>Researching a technique or technology relevant to your work

<li>Going for a walk to think about a difficult problem
</li>
</ul>
   </td>
  </tr>
...
You can expect payment within five business days of job or milestone completion, usually sooner.
