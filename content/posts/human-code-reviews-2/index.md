...
{{<img src="boulder.png" alt="Pushing the code review boulder back and forth" has-border="false">}}
...
{{<img src="letter-grade.png" alt="Reviewer helping author bring paper up by a letter grade" has-border="false">}}
...
{{<img src="instance-variables.png" alt="Example of pointing out repeated pattern" max-width="787px" has-border="false">}}
...
{{<img src="if-you-give-a-mouse-a-cookie.jpg" alt="If You Give a Mouse a Cookie" max-width="240px" align="right" has-border="false">}}
...
{{<img src="out-of-scope-1.png" alt="Example out of scope line" max-width="611px" has-border="false">}}
...
{{<img src="in-scope.png" alt="Example of in-scope line" max-width="637px" has-border="false">}}
...
{{<img src="out-of-scope-note.png" alt="Pointing out an issue that's out of scope" max-width="790px" has-border="false">}}
...
{{<img src="magician.png" alt="Magician splits large reviews" max-width="800px" has-border="false">}}
...
{{<img src="mma.png" alt="Sincere praise at an MMA match" max-width="650px" has-border="false">}}
...
{{<img src="pilots.png" alt="Tension during code review" max-width="850px" has-border="false">}}
...
_This article was edited by [Samantha Mason](https://www.samanthamasonfreelancer.com). Illustrations by Loraine Yow. Thanks to [@global4g](https://twitter.com/global4g) for providing valuable feedback on an early draft of this post._
