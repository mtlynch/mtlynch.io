...
For a deeper dive into excellent changelist descriptions, see my article, ["How to Write Useful Commit Messages."](https://refactoringenglish.com/chapters/commit-messages/)
...
{{<img src="having-trouble.png" alt="mtlynch: I'm having trouble understanding the purpose of this function. doggo: Oh, it's in case the caller passes a Frombobulator that's missing a frombobulate implementation.">}}
...
{{<img src="buried-change.png" alt="Changelist where logic changes are obscured by whitespace changes" caption="Can you spot the functional change buried in this changelist's whitespace noise?">}}
...
{{<img src="mixed-refactoring.png" max-width="550px" alt="Changelist where logic changes are obscured by refactoring changes" caption="This changelist makes a single change to behavior, but the refactoring changes obscure it.">}}
...
{{<img src="nice-catch.png" alt="Two developers are discussing a changelist. doggo: This actually won't work for January and February 1900. mtlynch: Wow, nice catch!" caption="Show gratitude when your reviewer catches a subtle bug in your code.">}}
...
{{<img src="ptal.png" alt="Screenshot of author saying 'Updated! Please take a look.'" caption="Comment on the changelist to communicate explicitly when you hand control back to your reviewer.">}}
...
_Illustrations by Loraine Yow. Edited by [Samantha Mason](https://www.samanthamasonfreelancer.com)._
