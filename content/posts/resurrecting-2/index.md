...
{{<img src="enable-travis.png" alt="Screenshot of enabling Travis" caption="Enabling Travis builds for ingredient-phrase-tagger library" max-width="677px">}}
...
{{<img src="first-travis-build.png" alt="Screenshot of first successful build on Travis CI" caption="First successful build on Travis" max-width="792px">}}
...
{{<img src="e2e-failing.png" alt="End-to-end test failing on Travis" caption="End-to-end test fails on Travis after passing on my local machine" max-width="800px">}}
...
{{<img src="e2e-fix.png" alt="Success after fixing end-to-end test" caption="End-to-end test passing on Travis" max-width="800px">}}
