...
Two years ago, I [quit my developer job at Google](/why-i-quit-google/) to build my own software business. A year later, I [posted an update](/solo-developer-year-1/) about my finances, happiness, and lessons learned. Today marks the end of my second full year, so it's time for another update.
...
My long-term unprofitability often perplexes people. They assume I fund my money-losing businesses with freelance work, but the truth is that I put 100% of my working hours into my non-lucrative businesses. This is possible due to three main factors:
...
Zestful is in a strange position because companies who parse ingredients never want to switch to Zestful. The cost and risk of migrating to a new API is too high relative to potential improvements in price or performance. Instead, all of Zestful's customers are companies building a brand new product.
...
At $2.3k of revenue, Is It Keto was my second-highest grossing product for 2019. I [abandoned the site in April](/retrospectives/2019/04/) but [came back four months later](/retrospectives/2019/09/) after realizing that it had grown on its own without me.
...
Revenue is also down, which is fine because I don't go out of my way to earn money from this blog. My development costs fell dramatically because the site's freelance developer shifted focus more to his full-time job. Rather than hiring someone else, I've taken over development myself, as I'm better at web development than I was a couple years ago.
...
As long as I was building What Got Done, I figured that I'd explore the possibility of making it into a business. After interviews with several businesses, it seemed that most managers felt that they could [achieve the same thing with a dedicated Slack channel](/retrospectives/2019/08/#why-use-what-got-done-when-we-have-slack), so I moved on.
...
Conferences are a big expense because travel and lodging is expensive, and the conferences that accepted my speaking proposals were regional events with minimal travel assistance budgets.

Switching from from Travis to Circle reduced my expenses by $68/month, which worked out great because it turned out that I love Circle. They improve faster and integrate better with Docker. Coveralls unfortunately auto-renewed without me consciously choosing to do so. I've since accepted that code coverage metrics have little value for early stage products and canceled for next year.

I also switched from managed bookkeeping with [Bench](https://bench.co) to self-serve bookkeeping with Xero. I enjoyed Bench and have no love for Xero, but I couldn't justify an extra $1.5k/year for concierge bookkeeping when my finances were so simple and repetitive.
...
Now that I'm entering my third year as a founder, I'm ready to make bigger bets. Growing Is It Keto gave me the confidence to push myself more. That means taking on projects where success would afford me a couple part-time contractors.
...
I did achieve this, in that I averaged $604/month for the year and $1,657/month for Q4, though it feels like cheating to include [my huge outlier sale](/retrospectives/2020/01/#zestfulhttpszestfuldatacom) from December. Without it, I'd be at $441 in total revenue for December, which is closer to what I expect the trend will be through early 2020. It's not quite $500, but it's satisfyingly close.
...
Depending on how you count, I either published 9 or 13 blog posts in 2019. I had nine separate updates to my blog, but one of them was [a five-part series on hiring content writers](/hiring-content-writers/). Overall, I'm pleased with my writing for the year, though I did [wish for more posts to gain traction](#mtlynchio-this-blog).
...
The project that I hope to focus on for a large portion of the coming year is [WanderJest](https://wanderjest.com), a website I started a few weeks ago.
...
I'm piloting it in my home area of Western Mass, but I'll soon expand it to other areas.
...
* Publish 10 blog posts.
  * This gives me time for one article per month with some room for longer posts and time off to prepare a conference presentation.
