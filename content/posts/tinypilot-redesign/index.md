...
I'm not trying to bash the agency here, so I'll just call them FooAgency. They're based in the US, and I found them through a [Hacker News monthly freelancer thread](https://news.ycombinator.com/submitted?id=whoishiring).

FooAgency quoted the highest rate of anyone I interviewed, but their portfolio best matched the style I wanted. They had a wide range of talent in-house, including design, custom illustrations, and 3D imaging.

Isaac, FooAgency's CEO, won my confidence during our initial call by suggesting I reduce the project's scope. Even though it meant less money for him, Isaac proposed a rebranding rather than a full-blown redesign. FooAgency would work on the fundamentals like a new logo, color scheme, and fonts.
...
FooAgency estimated that the rebrand would require 30-40 billable hours over two to four weeks. Their hourly rate was $175, so we were looking at $5-7k for a new logo and branding. That was half my budget, so it was an easy call.

Isaac warned that I was smaller than their other clients. Most of their customers had FooAgency on expensive long-term retainer agreements. This project was so tightly-scoped that we could do it hourly, but there was a possibility that they'd have to pause my work occasionally if a retainer client needed more time.
...
FooAgency invited me to meetings every two weeks with their lead designer, a senior designer, a project manager, and Isaac. They'd show me samples of the new logos and branding, and I'd give feedback. The next round, we'd be a little closer.

Within six weeks, we narrowed in on a concept we all liked.

{{<gallery caption="From oldest to newest, the progression of TinyPilot logo drafts that FooAgency showed me in the first few weeks of the project.">}}
...
In our first few meetings, FooAgency showed me mockups of my site with different color options.
...
As the project progressed, the mockups became more elaborate. FooAgency started showing me custom images and icons for the site.
...
A few weeks later, FooAgency called a meeting to share updates, but they hadn't made any progress on the logo or branding. Instead, they spent the whole meeting showing me design ideas for the website.
...
By December, we were three months into the project. FooAgency was 95% done with TinyPilot's new logo. All I wanted was to change some rounding on the corners and eliminate the border. I expected it to be a couple of hours of work.

I was eager to finalize the logo because it would be the first completed asset FooAgency was giving me. Once it was ready, I could publish it on the website, integrate it into the product's web interface, and print it on the device's physical case.

All I needed was a couple more hours of work. But I didn't get them.

{{<img src="new-logo-places.jpg" alt="Photos of TinyPilot website, app interface, and case showing the old logo" max-width="500px" has-border="true" caption="All the locations I could place the new TinyPilot logo once FooAgency delivered the final result.">}}

Instead, FooAgency kept redesigning the website. Their lead designer didn't have availability to work on the logo, but what did I think about this new design idea for the landing page?

The breaking point came when FooAgency started showing me new designs for my site's blog. From the beginning, I had said that I only cared about three pages: the landing page, the product page, and the shopping cart page. All other pages were explicitly out of scope.
...
I pointed this out to FooAgency, and Isaac called me, embarrassed. He admitted that the designers went beyond mere sketching. They were so excited about the project and got carried away, but he was going to remove the hours they'd spent redesigning the blog.

## The two-month holiday slowdown

Midway through December, I noticed FooAgency had stopped making progress on anything.
...
In early February, I emailed Isaac to ask what was going on. He called and apologized for how the project was going, admitting that internal issues at FooAgency were affecting my project. Their project manager quit in November, and Isaac was scrambling to fill the role himself while searching for replacements.

Isaac confirmed that I hadn't imagined the drop in quality. FooAgency was overloaded with work from their larger clients. Their designers were squeezing me in when they had a spare moment, but they probably weren't as focused as when we started.
...
The real issue, Isaac said, was that I was their only hourly client. I would always be at the mercy of long-term retainer clients pre-empting my project. So what if I signed a retainer agreement to guarantee FooAgency's time? Their retainers started at 40 hours per month for $160/hr.

I felt duped and manipulated. FooAgency structured the work so that everything was 80% done, but nothing was usable. If I took the work to a new vendor, there'd be a massive amount of rework. And now they were holding the last 20% hostage until I signed an expensive retainer agreement?
...
As diplomatically as possible, I told Isaac that I felt like the situation was FooAgency's fault. If a retainer agreement was better for everyone, why didn't they propose it months ago? The project could have been done by now.
...
Isaac proposed that FooAgency take over the dev work as well. FooAgency billed a higher rate than TinyPilot's in-house developers, but Isaac predicted they'd reduce costs overall. TinyPilot's devs specialize in programming languages like Python and JavaScript, but FooAgency's devs had more experience with design-heavy CSS work.
...
The retainer agreement started off well. Within the first week, FooAgency wrapped up almost all of the outstanding design tasks. There were still some slight kinks to work out, but two of the three pages were ready to hand over to the developers.

And then, radio silence.

For two weeks, there was no activity from the dev team. I asked Isaac what was going on, and he explained that FooAgency's schedule is fluid, so they don't necessarily work on my project every week. He assured me that by the end of the month, they'd certainly use the remaining 48 hours I'd booked for the month.

When the month ended, FooAgency hadn't moved the website any closer to the new design. Instead, they spent the last few days of the month fixing minor bugs from my issue tracker.

{{<img src="console-log.png" alt="Screenshot of new landing page" has-border="true" caption="One of the FooAgency developers used 15 of the month's 60 hours to fix the minor bugs from the end of the task queue.">}}

What inspired FooAgency to take on these insignificant bugs, you ask? Well, FooAgency had asked me to create Github tickets for each redesign task. FooAgency warned that they don't refund or roll over unused hours, so they encouraged me to overbook the schedule with tasks beyond the redesign work.

What I didn't expect was how FooAgency would split the tickets among their developers. I thought developer A would work on page X, and developer B would work on page Y. Instead, FooAgency assigned all the design-related tickets to developer A and left the rest to developer B. And that's how a quarter of the March dev budget went to minor bugfixes.
...
FooAgency pointed out that layering a new design onto a totally different theme would be messy. They proposed replacing the theme and our ad-hoc CSS with a custom TinyPilot Bootstrap theme. Their dev estimated that he'd only need a few days to complete the switch, and it would accelerate the rest of the project.
...
By May, we were seven months and $46k into what was supposed to be a four-week, $7k rebranding. Every month, it seemed like we were weeks away from the finish line, but something always popped up to prevent FooAgency from finishing anything I cared about.

It was time to call it. I gave FooAgency the required 28-days' notice to terminate the contract.

FooAgency required each month's payment upfront, so they already had all of my money for the final month. And now I'd fired them, so what incentive did they have to finish the work?

Surprisingly, the dev work was never smoother than after I terminated the contract. The project finally worked at the pace I expected from the beginning. FooAgency coded up each page within 7-10 days.

There were still issues, but I was prepared this time. FooAgency kept suggesting new flourishes to the design. I declined them all and told them to focus on the design I'd approved. I'm glad I did because they'd probably still be working on the website today.

On the last day of the month, the final page still wasn't done. FooAgency hadn't communicated with me about disengaging from the project.
...
Isaac was candid with me that the project hadn't gone as smoothly as he'd hoped. He felt that the underlying problem was FooAgency's difficulty scaling down their workflows to fit TinyPilot's budget. Their typical client has a retainer in the range of $20-40k per month. TinyPilot was buying only 40-60 hours per month, which they typically reserve for maintenance rather than new development.

I told Isaac that I wished we'd structured the work to give me usable assets sooner. I would have preferred to have the logo first, then a new navbar design, then the landing page design, etc. He said that FooAgency's clients are typically only interested in final results rather than intermediate pieces, but he understood why incremental work would have benefitted me.

I shared my surprise at how little FooAgency managed the project. I expected FooAgency's project managers to provide regular status updates and maintain project timelines, but nobody was doing that. Isaac said this was a misstep on his part. FooAgency tries to keep project management to less than 5% of billable hours. At my scale, 5% would be too limited to provide any tangible benefit, so he eliminated project management entirely. He admitted that, in retrospect, he should have included me in that conversation to make sure it was what I wanted.

We talked about the opaqueness of FooAgency's hours. Because they shared their hours so infrequently and worked an irregular schedule, I could never tell when a task was bloating beyond my expectations. I wished I'd raised this issue earlier because it turned out all I had to do was ask. FooAgency tracks billable time with [toggl](https://toggl.com), and Isaac would have been happy to give me access to their dashboard.
...
In my first meeting with FooAgency's team, I asked how long they expected my project to take. "How long is a piece of string?" their lead designer asked.
...
Many of the issues with scope bloat resulted from the slow feedback loop in FooAgency's reporting.

FooAgency's process is to report hours twice per month. On the 15th, they share the total number of hours they've used with no details about which tasks contributed to the total. At the end of the month, they send a per-task breakdown.

{{<gallery caption="FooAgency reports a simple total of hours on the 15th of the month and then a detailed breakdown at the end of the month.">}}
{{<img src="mid-month-report.png" alt="Screenshot of FooAgency's billing breakdown by task" max-width="400px"  has-border="true">}}
{{<img src="hours-summary.png" alt="Screenshot of FooAgency's billing breakdown by task" max-width="600px" has-border="true">}}
{{</gallery>}}
...
When we started the project, FooAgency told me that most of their clients were larger than I was, but they wanted to help me grow. It sounded like a great deal &mdash; I'd enjoy service normally reserved for large companies despite my limited budget.

{{<img src="big-airline.jpg" max-width="400px" caption="My initial conversation with FooAgency, as I remember it." alt="Scene from Mad Men where Mohawk Airlines tells Don Draper, 'You said Sterling Cooper Didn&rsquo;t need a big airline... you were going to make *us* a big airline.'">}}

In reality, I didn't get the same service as their larger clients. When I was an hourly client, FooAgency kept deprioritizing me in favor of their retainer clients. When I upgraded to a retainer plan, they struggled to work effectively within my budget.
...
FooAgency required payment up-front. For the hourly contract, I had to buy time in 30-hour blocks. For the monthly retainer, I had to pay each month's bill by the 1st of each month. There was no financial leverage to force them to complete the project.

If I had insisted on milestone-based payments from the beginning, FooAgency likely would have declined the project. They saw me as a small client who could grow, but nobody wants to work with a tiny client who's as demanding as a huge corporation.
...
Firing FooAgency and searching for a replacement would have burned 30-60 hours of management time. And there was no guarantee that I'd find someone better.
...
I genuinely believe that FooAgency tried their best on this project. I don't feel like they meant to deceive me or squeeze money out of me. We just didn't match. I was used to working with individual freelancers, and FooAgency was accustomed to larger clients.
...
It's too early to tell, but I'm optimistic about earning a positive return on the $46k I paid FooAgency.
