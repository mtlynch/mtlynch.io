...
{{<notice type="info">}}
_The Goal_ explains non-fiction ideas through a fictional story, so it's hard to explain without giving some basics on the story itself.
{{</notice>}}
...
1. Return on investment: Net profit must be judged in the context of initial investment.
...
1. Inventory: all the money the system has invested in purchasing things that it intends to sell.
...
1. Decide how to exploit the bottlenecks (i.e., maximize utilization of the bottleneck resources).
...
1. If, in a previous step, you eliminated a bottleneck, go back to step 1.
