...
Earlier this year, I created an open-source app called [PicoShare](https://github.com/mtlynch/picoshare). It's a simple Golang web app for sharing files. I use it to send files that are too large to be email attachments, but I don't want the recipient to deal with Dropbox or Google Drive.
