...
{{<img src="homerun-3.jpg" max-width="800px" alt="UX for creating job applications in Homerun">}}
...
{{<gallery>}}
{{<img src="homerun-1.jpg" max-width="400px" alt="Kanban overview of job applicants">}}
{{<img src="homerun-2.jpg" max-width="400px" alt="Detailed view of applicant">}}
{{</gallery>}}
...
{{<img src="polymer-ux.png" max-width="600px" alt="Polymer's UI with many nested options" caption="Polymer's UX was a little crowded with nested menu options for unrelated tasks">}}
...
{{<gallery>}}
{{<img src="recruitee-1.png" max-width="400px" alt="Kanban overview of job applicants">}}
{{<img src="recruitee-2.png" max-width="400px" alt="Detailed view of applicant">}}
{{</gallery>}}
...
{{<gallery>}}
{{<img src="breezy-1.png" max-width="400px" alt="Kanban overview of job applicants">}}
{{<img src="breezy-2.png" max-width="400px" alt="Detailed view of applicant">}}
{{</gallery>}}
...
{{<gallery>}}
{{<img src="join-1.jpg" max-width="400px" alt="Kanban overview of job applicants - empty because JOIN doesn't allow me to enter candidates without manual approval">}}
{{<img src="join-2.jpg" max-width="400px" alt="Applicant view of job listing with a banner saying that JOIN is currently reviewing my account">}}
{{</gallery>}}
...
{{<img src="join-locked.png" max-width="800px" alt="JOIN login screen says 'Your account is currently unavailable. Talk to us' which pops up a live chat interface">}}
...
{{<img src="hireproof-1.png" max-width="700px" alt="Hireproof screen showing instructions about interviewing a candidate and recording their responses">}}
...
{{<img src="hireproof-2.png" max-width="700px" alt="Hireproof screen showing a wall of UI controls with no clear call to action">}}
