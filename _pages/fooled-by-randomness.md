...
* [Black swan problem](https://en.wikipedia.org/wiki/Problem_of_induction)
  ...
  * People tend to underestimate the probability of black swan events and make themselves very vulnerable when such events occur.
  * "...it does not matter how frequently something succeeds if failure is too costly to bear."
* More experienced traders tend naturally to be more resistant to rare events because their longer trading lifespan means it's likely that they've experienced previous rare events and survived them.
...
* Traders must consider both the probability and magnitude of an event
  ...
  * The 5% chance can be even more profitable because markets tend to understimate the probability of a rare event.
...
* A possible evolutionary psychology explanation for human biases is that most of human evolution did not require understanding of probabilities
