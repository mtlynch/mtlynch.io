...
In this section, I explain how I screen candidates to filter out obvious mismatches, and how I select writers to hire on a trial basis.

## Evaluation criteria

Before you hire a writer, you have to judge them based on the information available. Here's what I've learned from my experience with these signals.

### Hourly rate

It's natural to assume that a $60/hr writer is substantially better than a $30/hr writer, but I found this not to be the case. The rate that writers billed seemed unrelated to the quality of their writing. On Upwork, the best writer I found was also the one who charged the lowest rate ($20/hr).
...
All professional writers should be able to provide you with writing samples, but they're not always an accurate reflection of their ability. Conversely, if the article feels boring and convoluted, it could be because the client asked for a 2,000-word article about a 500-word topic. The opposite can happen as well. The writer can have a sample with impeccable grammar and clear language, but it's because the editor of the piece cleaned up their mistakes.

When I read writing samples, I'm looking for writing that's either extremely good or extremely bad. I can reject extremely bad writing. If the writing samples in their public portfolio are so-so, I'll reach out to the writer directly and ask if they have a writing sample that's closer to [my site's style](/hiring-content-writers/4-working-with-writers/#use-a-style-guide-to-enforce-consistency).
...
The Internet is experiencing an epidemic of fluff writing. Site owners [think that Google will place their pages higher](https://moz.com/blog/blog-post-length-frequency) in results if they have a higher word count. And many writers are paid by the word, so wordier pieces earn them more money. As a result, instead of learning to write well, many writers have learned to write fluff.

You can recognize fluff if it sounds like you're reading a book report from a fifth grader who forgot to do the reading. Below, I've included an example of fluff writing. To avoid picking on any particular writer, I wrote the passage myself, but it's depressingly similar to some writing samples I've received:
...
* The writing feels desperate to be interesting.
  * Hyperbole
  * ALL CAPS
  * Exclamation points!!!
...
It can take weeks or months to find a writer that produces the content you want. During that time, it's easy for desperation to set in. Several times, I found mediocre writers and thought to myself, "Oh, their writing is rough, but I can coach them to improve it." This never worked. 
...
When you proactively reach out, take the same steps as if you're evaluating an inbound candidate. Read their bio and check their writing samples.

Writers get generic spam solicitations all the time, so a personalized invitation instantly makes you stand out as a client who respects their work. Mention specifics about what you liked about their writing and why you feel that they'd be a good match for the job.

Be clear that you're not offering them a job right off the bat. You should have at least a small amount of back-and-forth before you make a formal offer.
